...
if __name__ == "__main__": 
	...
	k_fold(experiment_name=args.name,
		k=args.k_fold,
		n=9,
		splits=splits,w=0,train=False,train_real=False,generate=False,
		fine_tune=True)
	# k_fold(experiment_name=args.name,
	# 	k=args.k_fold,
	# 	n=9,
	# 	splits=splits,w=8,train=False,train_real=False,generate=False)
	# k_fold(experiment_name=args.name,
	# 	k=args.k_fold,
	# 	n=9,
	# 	splits=splits,w=3,train=False,train_real=False,generate=False)
	# k_fold(experiment_name=args.name,
	# 	k=args.k_fold,
	# 	n=9,
	...
	# 	k=args.k_fold,
	# 	n=9,
	# 	splits=splits,w=20,train=False,train_real=False,generate=False)